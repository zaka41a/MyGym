...
if (!$avatarUrl) {
  $avatarUrl = 'https://via.placeholder.com/120x120?text=+';
}
$avatarStatusText = $hasAvatar ? 'Custom avatar uploaded' : 'Add a picture to personalize your profile.';
  ...
  <div class="container">
    ...
    <main class="main-content">
      <div class="header">
        <div>
          <h1>My Profile</h1>
          <p style="color:#9ca3af;">Keep your personal information up to date.</p>
        </div>
      ...
      <div class="profile-hero">
        ...
        <div class="profile-hero-info">
          ...
          <p class="profile-role"><ion-icon name="barbell"></ion-icon> Member</p>
        ...
        <div class="profile-completion-ring">
          <svg width="120" height="120">
            <circle cx="60" cy="60" r="54" fill="none" stroke="rgba(239, 68, 68, 0.2)" stroke-width="8"/>
            <circle cx="60" cy="60" r="54" fill="none" stroke="url(#ringGradientMember)" stroke-width="8"
                    stroke-dasharray="339.292" stroke-dashoffset="<?= 339.292 - (339.292 * $profileCompletion / 100) ?>"
                    stroke-linecap="round" transform="rotate(-90 60 60)"/>
            <defs>
              <linearGradient id="ringGradientMember" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stop-color="#ef4444"/>
